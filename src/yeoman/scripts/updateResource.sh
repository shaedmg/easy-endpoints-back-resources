...
expect {
    "*Overwrite src/api/$var/index.js?" { send -- "y\r" }
}
expect {
    "*Overwrite src/api/$var/index.test.js?" { send -- "y\r" }
}
expect {
    "*Overwrite src/api/$var/model.js?" { send -- "y\r" }
}
expect {
    "*Overwrite src/api/$var/model.test.js?" { send -- "y\r" }
}
expect {
    "*Overwrite src/api/index.js?" { send -- "n\r" }
}
expect eof
exit 0
